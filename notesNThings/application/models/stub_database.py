...
stubCourses = {'courses': [ 
	...
	{'id': 2, 'courseID': '2', 'term': None, 'name': 'COMP TEST', 'alt_name': "Brogramming 2.0", 'professor': None} ]
}

stubUsers = {'users': [ 
	{'id': 0, 'uid': '0', 'username': 'user1', 'password': 'password', 'email': "test@mail.com", 'admin': True}]
}

stubTests = {'tests': [ 
	{'id': 0, 'uid': '0', 'name': 'user1'},
	{'id': 1, 'uid': '1', 'name': 'user2'},
	{'id': 2, 'uid': '2', 'name': 'user3'}]
}